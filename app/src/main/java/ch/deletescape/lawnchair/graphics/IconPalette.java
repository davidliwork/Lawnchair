...
public class IconPalette {
    ...
    private IconPalette(int color, boolean desaturateBackground) {
        dominantColor = color;
//        backgroundColor = desaturateBackground ? getMutedColor(dominantColor, 0.87f) : dominantColor;//源码方案
        backgroundColor = Color.RED;//产品设计需求，直接改成红色背景
...
//        textColor = getTextColorForBackground(backgroundColor);//源码方案
        textColor = Color.WHITE;//产品设计需求，直接改成白色字体
